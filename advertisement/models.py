...
from advertisement.managers import AdManager
...
class Advertiser(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _('Manage Advertisers')
...
class Category(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _('Manage Categories')
        ordering = ('title',)
...
class Ad(models.Model):
    ...
    page = models.CharField(
        verbose_name=_('Pages'), max_length=100)
    ...
    class Meta:
        ...
        verbose_name_plural = _('Manage Advertisements')

    def __str__(self):
        return self.title

    def get_absolute_url(self):
        return reverse('advertisement:ad-click', kwargs={
            'pk': self.id})

    def get_admin_absolute(self):
...
class AdVideo(models.Model):
    ...
    video = models.FileField(verbose_name=_('Video'), max_length=255)
...
class Impression(models.Model):
    ...
    class Meta:
        verbose_name = _('Advertisement Impression')
        verbose_name_plural = _('View Advertisement Impressions')
        index_together = (
            ('ad', 'session_id', )
        )
...
class Click(models.Model):
    ...
    class Meta:
        verbose_name = _('Advertisement Click')
        verbose_name_plural = _('View Advertisement Clicks')
        index_together = (
            ('ad', 'session_id', )
        )
