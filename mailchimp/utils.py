...
class MailChimpUtils(object):
    def __init__(self):
        super(MailChimpUtils,self).__init__()
    ...
    def change_subscription_status(self,email,status='unsubscribed'):
        ...
        request = requests.put(endpoint,auth=("",self.key),data=json.dumps(data))
        return request.json()
    ...
    def add_email(self,email):
        ...
        print(endpoint)
        request = requests.post(endpoint,auth=("",self.key),data=json.dumps(data))
