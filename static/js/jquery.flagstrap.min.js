    ...
    a.flagStrap = function(t, i, r) {
        ...
        var g = function() {
            ...
            p = function() {
                ...
                var i = a("<span/>").addClass("flagstrap-selected-" + s).html(t).append(""),
            ...
            S = function() {
                ...
                return o.settings.scrollable && e.css("height", "auto").css("max-height", o.settings.scrollableHeight).css("overflow-x", "hidden"), a(c).find("option").each(function() {
                   ...
                   // a(this)['context'].lastChild.data = ""
                   var num = a(this).html().lastIndexOf(">");

console.log(a(this).html().slice(0,num+1))
                            a(c).val(a(this).data("val")), a(c).trigger("change"), a(".flagstrap-selected-" + s).html(a(this).html().slice(0,num+1)), e.preventDefault()
                        }),
                        l = a("<li/>").prepend(r)
